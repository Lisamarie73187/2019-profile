    ...
    <div className="aboutMeWrapper">
      ...
      <div className="aboutMe">
        ...
        <p>
          ...
          constant learning and challenging work made this career the perfect fit and due to my previous experience I was able to apply my knowledge of consumer and customer satisfaction into
          my work.
        </p>
        <p>
